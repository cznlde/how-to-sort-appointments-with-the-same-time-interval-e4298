...
Namespace IExternalAppointmentCompareSample
    ...
    Partial Public Class CarsDBDataSet
        ...
        Partial Public Class CarSchedulingDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddCarSchedulingRow(ByVal CarId As Integer, ByVal UserId As Integer, ByVal Status As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label As Integer, ByVal StartTime As Date, ByVal EndTime As Date, ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType As Integer, ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Price As Decimal, ByVal ContactInfo As String) As CarSchedulingRow
    ...
    End Class
End Namespace
Namespace IExternalAppointmentCompareSample.CarsDBDataSetTableAdapters
